...
const StatCard: React.FC<{
  ...
  <Card
    className={
      (className ?? "") +
      " bg-card/50 transition-all duration-300 hover:border-primary/50"
    }
  >
          ...
          {!dashboardData.stats ? (
            ...
            <>
              ...
              <StatCard
                ...
                value={dashboardData.stats.monthlyExpenses.toLocaleString(
                  "en-US",
                  {
                    style: "currency",
                    currency: "USD",
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {!dashboardData.stats ? (
            ...
            <>
              ...
              />
              <StatCard
                title="Tasks Done (Week)"
                value={dashboardData.stats.tasksCompletedThisWeek}
              ...
              <StatCard
                ...
                value={dashboardData.stats.topicsInProgress}
