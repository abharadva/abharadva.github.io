        ...
        >
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <BookUser className="size-5 text-primary" /> Hero & About
                  Content
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-3 bg-secondary/30">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          form.setValue(
                            "profile_data.default_theme",
                            c ? "theme-custom" : "theme-blueprint",
                          )
                        }
                      />
                    </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <PanelRightOpen className="size-5 text-primary" /> Hero Status
                  Panel
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <LayoutDashboard className="size-5 text-primary" /> Global
                  Layout
                </CardTitle>
              </CardHeader>
              <CardContent>
