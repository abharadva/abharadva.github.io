...
export default function TopicEditor({ topic, onBack, onTopicUpdate }: TopicEditorProps) {
  ...
  useEffect(() => {
    ...
    const handler = setTimeout(() => handleSave({ core_notes: coreNotes }, true), 3000);
        ...
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-muted-foreground font-mono mt-0.5">
              LAST EDITED: {formatDate(new Date(topic.updated_at || new Date()))}
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-background/50 relative">
          <div className="absolute inset-0 overflow-hidden">
             <AdvancedMarkdownEditor
               ...
               onImageUploadRequest={() => toast.info("Image upload coming soon.")}
               minHeight="100%"
             />
          </div>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  {resources.length === 0 && (
                    ...
                    >
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1">Add links, docs, or videos.</p>
                    </div>
                  )}
                </div>
              </section>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-muted-foreground">
                Prefix with <strong>Article</strong>, <strong>Video</strong>, <strong>Course</strong>, or <strong>Official</strong> to auto-assign an icon.
              </p>
            </div>
            <div className="space-y-2">
