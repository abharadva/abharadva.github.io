...
export default function TopicEditor({
  ...
  const topicSessions =
    learningData?.sessions.filter((s) => s.topic_id === topic?.id) || [];
  ...
  const totalTime = topicSessions.reduce(
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-xs text-muted-foreground font-mono">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>
                Updated: {formatDate(new Date(topic.updated_at || new Date()))}
              </span>
            </div>
          </div>
        </div>
      ...
      <Tabs defaultValue="study" className="flex-1 flex flex-col min-h-0">
        <div className="flex items-center justify-between border-b bg-background/50">
          <TabsList className="h-auto bg-transparent p-0 w-full justify-start gap-6">
            <TabsTrigger
              value="study"
              className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:text-primary bg-transparent shadow-none px-2 py-3 transition-all hover:text-foreground/80"
            >
            ...
            >
              ...
              {resources.length > 0 && (
                <span className="ml-2 text-[10px] bg-secondary text-secondary-foreground px-1.5 py-0.5 rounded-full">
                  {resources.length}
                </span>
              )}
            </TabsTrigger>
        ...
        <TabsContent
          value="study"
          className="flex flex-col gap-6 mt-6 min-h-0 overflow-y-auto pr-2 animate-in fade-in-50 duration-300 slide-in-from-bottom-2"
        >
            ...
            <div className="flex-1 overflow-hidden">
              <AdvancedMarkdownEditor
                ...
                onImageUploadRequest={() =>
                  toast.info("Image upload for learning notes coming soon")
                }
                minHeight="100%"
              />
            </div>
        ...
        <TabsContent
          value="resources"
          className="mt-6 overflow-y-auto pr-2 animate-in fade-in-50 duration-300 slide-in-from-bottom-2"
        >
            ...
            <div className="flex justify-between items-end mb-8">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Curate links, documentation, and tutorials.
                </p>
              </div>
              <Button
            ...
            {resources.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 border-2 border-dashed border-border/60 rounded-xl bg-secondary/5">
                ...
                <p className="text-sm text-muted-foreground mt-1 mb-6 max-w-sm text-center">
                  Keep track of documentation, video tutorials, and articles
                  ...
                  {resources.map((res, index) => (
                    ...
                    >
                      <ResourceCard
                        ...
                        onEdit={(name, url) =>
                          handleUpdateResource(index, name, url)
                        }
                      />
                    </motion.div>
                  ))}
        ...
        <TabsContent
          value="history"
          className="mt-6 overflow-y-auto animate-in fade-in-50 duration-300 slide-in-from-bottom-2"
        >
            ...
            {topicSessions.length === 0 ? (
              <div className="text-center py-20 text-muted-foreground">
                ...
                <p className="max-w-sm mx-auto mt-2 text-sm">
                  Start the timer in the "Study" tab to begin tracking your
