    ...
    >
      ...
      <Card>
          ...
          <div>
            ...
            <CardDescription>
              {mfaEnabled
                ...
                : factors.length > 0
                  ? "You have MFA factors registered, but not all may be fully verified."
        ...
        <CardContent>
          ...
          {!isLoading && factors.length > 0 && (
            <div className="space-y-3">
              ...
              {factors.map((factor) => (
                <div
                  key={factor.id}
                  className="flex flex-col items-start gap-2 rounded-md border bg-secondary p-3 sm:flex-row sm:items-center sm:justify-between"
                >
                  <div>
          ...
          {!isLoading && factors.length === 0 && !factorsError && (
            <p className="text-sm text-muted-foreground">
