// src/components/admin/tasks/TaskKanbanBoard.tsx
"use client";
          ...
          >
            ...
            <div className="flex-1 p-3">
              <div className="flex flex-col gap-3">
                ...
                {colTasks.length === 0 && (
                  <div className="flex items-center justify-center h-24 rounded-lg border-2 border-dashed border-muted-foreground/10 text-muted-foreground/50 transition-all text-sm font-medium">
                    Drop tasks here
                  </div>
                )}
              </div>
