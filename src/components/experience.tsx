    ...
    <section className="my-16 py-16">
      {showTitle && (
        ...
        >
          ...
          <span
            className="absolute -top-8 left-1/2 -translate-x-1/2 text-[6rem] font-black text-foreground/5 -z-1 select-none"
            aria-hidden="true"
          >
      ...
      {!!error && (
        <div className="text-center text-destructive">
          Could not load experience data.
        </div>
      )}
      ...
      {!isLoading && !error && experienceItems.length === 0 && (
        <div className="py-16 text-center text-muted-foreground">
          ...
          <p className="mt-4">
            A detailed timeline of my professional journey will appear here
            soon.
          </p>
        </div>
      )}
