...
export const siteContent = {
  ...
  pages: {
    about: {
      title: "About Me",
      description:
        "Learn more about Akshay Bharadva, the developer behind the code.",
      heading: "[ ABOUT_ME ]",
      bio: [
    ...
    contact: {
      title: "Contact Me",
      description:
        "Let's build something great together. Get in touch with Akshay Bharadva.",
    ...
    projects: {
      title: "My Projects",
      description:
        "A collection of projects developed by Akshay Bharadva, showcasing skills in various technologies.",
      heading: "Projects",
    },
    showcase: {
      title: "Showcase",
