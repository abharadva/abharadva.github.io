    ...
    try {
      ...
      if (siteSettingsData) {
        ...
        await runTest("SiteSettings: Update", () =>
          updateSiteSettings({
            settings: { portfolio_mode: newMode },
            identity: {},
          }).unwrap(),
        );
        await runTest("SiteSettings: Revert", () =>
          updateSiteSettings({
            settings: { portfolio_mode: originalMode },
            identity: {},
          }).unwrap(),
        );
      } else {
        addLog({
          ...
          status: "success",
          message: "Original settings not loaded.",
        });
      }
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            This will perform live database operations. While it cleans up after
        ...
        <Card>
          ...
          <CardContent>
            <ScrollArea
              ref={logContainerRef}
              className="h-96 w-full rounded-md border p-4 font-mono text-sm"
            >
