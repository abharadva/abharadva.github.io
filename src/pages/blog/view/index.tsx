      ...
      <div className="text-sm">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5">
            <Clock className="size-4" /> {readTime} min read
          </span>
          <span className="hidden sm:inline">·</span>
          <span className="flex items-center gap-1.5">
            <Eye className="size-4" /> {(post.views || 0).toLocaleString()}{" "}
            views
          </span>
        </div>
      </div>
    ...
    <div>
      ...
      <div className="flex gap-2">
        <Button variant="outline" onClick={onShareX}>
          <BsTwitterX className="mr-2 size-4" /> X
        </Button>
...
const BlogPostSkeleton = () => (
  <div className="mx-auto max-w-4xl px-4 py-8 md:py-16">
    ...
    <Skeleton className="my-8 h-80 w-full rounded-lg" />
