    ...
    <Layout>
      <Head>
        ...
        <meta
          ...
          content={pageStaticContent.description}
        />
      ...
      <main className="mx-auto max-w-5xl px-4 py-16 font-sans md:py-24">
        ...
        <motion.div className="mt-24">
          <motion.h2
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="mb-10 text-center text-4xl font-bold text-muted-foreground"
          >
            {pageStaticContent.servicesTitle}
          </motion.h2>
          ...
          {!isLoadingServices &&
            (!serviceSection?.portfolio_items ||
              ...
              >
                ...
                <p className="mt-4">
                  Services I offer will be listed here soon.
                </p>
              </motion.div>
            )}
        </motion.div>
