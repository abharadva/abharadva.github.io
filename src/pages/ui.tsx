          ...
          <main ref={mainContentRef} className="w-full">
            ...
            <ComponentDocSection id="avatar" title="Avatar">
              <VariationDisplay title="User Avatar">
                <Avatar>
                  <AvatarImage
                    src="https://github.com/abharadva.png"
                    alt="@abharadva"
                  />
              ...
              <VariationDisplay title="User Profile Menu">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56">
                    <DropdownMenuLabel>Akshay Bharadva</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>
              ...
              <VariationDisplay title="Profile Preview">
                <HoverCard>
                  <HoverCardTrigger asChild>
                    <Button variant="link">@abharadva</Button>
                  </HoverCardTrigger>
                  <HoverCardContent className="w-80">
                    <div className="flex items-center gap-4">
                      <Avatar>
                        <AvatarImage src="https://github.com/abharadva.png" />
                        <AvatarFallback>AB</AvatarFallback>
                      </Avatar>
                      <div>
                        <h4 className="font-semibold">Akshay Bharadva</h4>
